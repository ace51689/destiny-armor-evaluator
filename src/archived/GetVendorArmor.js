...
const GetVendorArmor = () => {
  ...
  useEffect(() => {
    ...
    const gettingOneVendor = async (classHash) => {
      getVendors(memberType, destinyId, classHash, authToken)
        .then((res) => {
          console.log(res)
...
// const vendorHashes = ["2190858386", "350061650", "69482069", "248695599", "3603221665", "396892126", "1576276905"]
              ...
              // const gettingOneVendor = async (classHash, armorArray) => {

              //   await getVendors(memberType, destinyId, classHash, authToken)
              //     .then((res) => {
              //       console.log(res)
              //       const releventVendorSales = Object.entries(res.Response.sales.data).filter((vendor) => {
              //         if (vendorHashes.includes(vendor[0])) {
              ...
              // gettingOneVendor('2305843009261410595', armorArray)
